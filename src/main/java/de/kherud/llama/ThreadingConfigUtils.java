...
public class ThreadingConfigUtils {
	...
	public static void saveThreadingProfile(String profileName, ThreadingConfig config) {
		try {
			...
			System.out.println("💾 Saved threading profile: " + profileName);
	...
	public static boolean deleteThreadingProfile(String profileName) {
		try {
			...
			if (found) {
				saveThreadingProperties(props);
				System.out.println("🗑️ Deleted threading profile: " + profileName);
				return true;
			}
	...
	public static ModelParameters applyThreadingProfile(ModelParameters params, String profileName) {
		...
		System.out.println("🔧 Applied threading profile: " + profileName + 
	...
	public static void createDefaultProfiles() {
		...
		System.out.println("✅ Created default threading profiles");
	}
	...
	public static void printProfile(String profileName) {
		...
		System.out.println("📋 Threading Profile: " + profileName);
		System.out.println("   Threads: " + config.threads);
		System.out.println("   Batch Threads: " + config.batchThreads);
		System.out.println("   Workload Type: " + config.workloadType);
	...
	public static void printAllProfiles() {
		...
		if (profiles.length == 0) {
			System.out.println("No threading profiles found. Use createDefaultProfiles() to create some.");
			return;
		}
		...
		for (String profile : profiles) {
			...
			if (config != null) {
				System.out.printf("   • %s: %d threads, %d batch (%s)\n", 
