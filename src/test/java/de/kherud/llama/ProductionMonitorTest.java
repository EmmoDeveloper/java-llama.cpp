...
public class ProductionMonitorTest {
	...
	public void testBasicMetricsCollection() {
		...
		System.out.println("✅ Basic metrics collection test passed!");
	}
	...
	public void testModelSpecificStatistics() {
		...
		System.out.println("Fast model: " + fastStats.getTokensPerSecond() + " tokens/sec");
		System.out.println("Slow model: " + slowStats.getTokensPerSecond() + " tokens/sec");
		System.out.println("✅ Model-specific statistics test passed!");
	}
	...
	public void testErrorTracking() {
		...
		System.out.println("Health status: " + ProductionMonitor.getHealthStatus());
		System.out.println("✅ Error tracking test passed!");
	}
	...
	public void testHealthySystem() {
		...
		System.out.println("✅ Healthy system test passed!");
	}
	...
	public void testStatusReport() {
		...
		System.out.println("✅ Status report test passed!");
	}
	...
	public void testModelLifecycle() {
		...
		System.out.println("✅ Model lifecycle test passed!");
	}
}