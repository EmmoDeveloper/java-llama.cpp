...
public class MemoryAnalysisTest {
	...
	public void testMemoryUsagePatterns() {
		...
		MemorySnapshot afterLoad = null;
		MemorySnapshot afterGeneration = null;
	...
	private static class MemorySnapshot {
		...
		MemorySnapshot(String name, long heapUsed, long heapMax, long nonHeapUsed) {
			this.name = name;
		...
		public String toString() {
			return String.format("%s: Heap=%dMB/%dMB, NonHeap=%dMB", 
				name, heapUsed / MB, heapMax / MB, nonHeapUsed / MB);
		}
	}
}